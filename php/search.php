...
$query = "SELECT * FROM users where (fname LIKE ? OR lname LIKE ?) AND (unique_id != ?) "; //find user by firstname or lastname
$stmt = $conn->prepare($query);
$stmt->execute([$_POST["searchTerm"], $_POST["searchTerm"], $_SESSION["unique_id"]]);
$result = $stmt->fetchAll();
$output = "";

if ($result) { //if users are found
